...
class Taxi(Model):
    ...
    registration = models.CharField(
        validators=[MinLengthValidator(4), MaxLengthValidator(8)], unique=True
    )
    ...
    seatCount = models.IntegerField(
        db_column="seat_count", validators=[MinValueValidator(1)]
    )
...
class Course(Model):
    ...
    startLatitude = models.FloatField(
        db_column="start_latitude",
        validators=[MinValueValidator(-90.0), MaxValueValidator(90.0)],
    )
    startLongitude = models.FloatField(
        db_column="start_longitude",
        validators=[MinValueValidator(-180.0), MaxValueValidator(180.0)],
    )
    endLatitude = models.FloatField(
        db_column="end_latitude",
        validators=[MinValueValidator(-90.0), MaxValueValidator(90.0)],
    )
    endLongitude = models.FloatField(
        db_column="end_longitude",
        validators=[MinValueValidator(-180.0), MaxValueValidator(180.0)],
    )
    passengerCount = models.IntegerField(
        db_column="passenger_count", validators=[MinValueValidator(1)]
    )
...
class TaxiTimestamp(TimescaleModel):
    ...
    fuelConsumption = models.FloatField(
        db_column="fuel_consumption", validators=[MinValueValidator(0.0)]
    )
